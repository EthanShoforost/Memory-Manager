...
### Windows
- Download: [`Memory_Manager.pyw`](windows/Memory_Manager.pyw)
- Requirements: Python 3.10 or newer

### macOS
- Download: [`Memory_Manager_Mac.zip`](mac/Memory_Manager_Mac.zip)
- Requirements: Python 3.10 or newer
...
- **Libraries won't install** - Run `python -m pip install requests beautifulsoup4 Pillow opencv-python numpy`

### Mac
- **Security warnings** - See the [Mac Guide](docs/Memory_Manager_Mac_Guide.docx) for bypass instructions
- **Terminal won't close** - Press Cmd+Q on Terminal in Dock
- **"Python not found"** - Install Python from python.org

For more troubleshooting, see the complete guides in the `docs` folder.
